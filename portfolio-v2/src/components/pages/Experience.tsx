...
export function Experience()
{
    return(
        <MouseParallaxChild className="size-full animate-fade-up flex flex-col gap-0 overflow-y-scroll">
            ...
            <div className="text-xl/9 font-(family-name:--font-haas-grot-disp-55-roman) px-4 md:px-8 lg:px-0 grid grid-cols-5 gap-4 w-full">
                {
                    jobs.map((v, i)=>{
                        return(
                            <>
                                    ...
                                    <div className={`text-left flex flex-row gap-4`}>
                                        ...
                                        <div className="flex flex-col justify-between gap-1 lg:gap-2 w-full overflow-x-scroll">
                                            ...
                                            <div className="flex flex-row gap-2">
                                                ...
                                                v.links.map((l)=>{
                                                    return(
                                                        <a href={l} target="_blank" className="text-base bg-[#00000041] border border-[#c2c2c2] sm:text-xl tracking-wide font-(family-name:--font-haas-grot-disp-55-roman) outline-0 outline-offset-4 hover:outline-1 text-zinc-300 flex flex-row w-fit p-1 sm:p-2 gap-2">

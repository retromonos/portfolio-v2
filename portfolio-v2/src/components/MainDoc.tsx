        ...
        <div id="maindoc" className="bg-gray-950 size-full p-4 pt-2">
            <MouseParallaxContainer globalFactorX={0.025} globalFactorY={0.025} className="border-2 border-gray-700 size-full flex flex-row p-8 font-(family-name:--font-haas-grot-disp-65)">
                <div className="flex flex-col gap-4">
                    <div className="flex flex-row gap-8 w-full justify-end text-[#dedede]">
                        ...
                        <button className="text-2xl text-right tracking-wider border-b-2 border-[#c2c2c2] px-4 py-1">PHOTOS</button>
                        <button className="text-2xl text-right tracking-wider border-b-2 border-[#c2c2c2] px-4 py-1">PROJECTS</button>
                        <button className="text-2xl text-right tracking-wider border-b-2 border-[#c2c2c2] px-4 py-1">INFORMATION</button>
                    </div>
                    <MouseParallaxChild className="text-xl font-(family-name:--font-haas-grot-disp-45) overflow-y-scroll">
